	...
	projects := []Project{
		{
			...
			Notes:           "Most recent work added auth and dining flow observability, updated Go and container build versions, refreshed workflow notes, and strengthened auth middleware coverage.",
			Tech: []string{
				"Go",
				"HTMX",
				"Tailwind-style CSS",
		...
		},
		{
			...
			Notes:           "Most recent work added auth and dashboard flow observability, updated Go and container build versions, and expanded request and security middleware coverage.",
			Tech: []string{
				"Go",
				"HTMX",
				"Templ",
		...
		},
		{
			...
			Notes:           "Most recent work added sanitized auth and learning flow observability, updated Go and container build versions, and expanded request logging coverage.",
			Tech: []string{
				"Go",
				"Templ",
				"Tailwind CSS",
		...
		},
		{
			...
			Notes:           "Most recent work added auth, movie, entry, and rating flow observability, updated Go and container build versions, and expanded request logging coverage.",
			Tech: []string{
				"Go",
				"Templ",
				"Tailwind CSS",
