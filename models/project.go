...
func Projects() []Project {
	projects := []Project{
		...
		},
		{
			...
			Notes:           "Most recent work added Southern cuisine classification, improved auth and dining flow observability, and published clearer, safer self-hosting guidance.",
			Tech: []string{
				"Go",
				"HTMX",
				"Tailwind-style CSS",
		...
		},
		{
			...
			Notes:           "Most recent work improved auth and progress flow observability and published clearer, safer self-hosting guidance.",
			Tech: []string{
				"Go",
				"HTMX",
				"Templ",
		...
		},
		{
			...
			Notes:           "Most recent work simplified the family Trophy Room around three friendly awards, a family top five, and clearer totals while publishing safer self-hosting guidance.",
			Tech: []string{
				"Go",
				"Templ",
				"Tailwind CSS",
		...
		},
		{
			...
			Notes:           "Most recent work refreshed portfolio project notes and published a concise self-hosting guide with safer environment setup.",
			Tech: []string{
				"Go",
				"HTML templates",
				"Tailwind CSS",
