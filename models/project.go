	...
	projects := []Project{
		{
			...
			Notes:           "Most recent work added safer public self-hosting guidance, strengthened local secret protections, and refreshed contributor workflow notes.",
			Tech: []string{
				"Go",
				"HTMX",
				"Tailwind-style CSS",
		...
		},
		{
			...
			Notes:           "Most recent work added safer public self-hosting guidance, strengthened local secret protections, and streamlined contributor workflow documentation.",
			Tech: []string{
				"Go",
				"Templ",
				"Tailwind CSS",
		...
		},
		{
			...
			Notes:           "Most recent work added safer public self-hosting guidance and streamlined contributor workflow documentation.",
			Tech: []string{
				"Go",
				"Templ",
				"Tailwind CSS",
		...
		},
		{
			...
			Notes:           "Most recent work refreshed portfolio project recency notes, added safer public self-hosting guidance, and updated contributor workflow documentation.",
			Tech: []string{
				"Go",
				"HTML templates",
				"Tailwind CSS",
		...
		},
		{
			...
			Notes:           "Most recent work added safer public self-hosting guidance, clarified production cookie configuration, and streamlined contributor workflow documentation.",
			Tech: []string{
				"Go",
				"Chi",
				"Angular",
