	...
	projects := []Project{
		{
			...
			Notes:           "Most recent work added Southern cuisine categorization, safer public self-hosting guidance, refreshed workflow notes, and expanded auth and dining flow observability.",
			Tech: []string{
				"Go",
				"HTMX",
				"Tailwind-style CSS",
		...
		},
		{
			...
			Notes:           "Most recent work added safer public self-hosting and secret-handling guidance alongside auth and dashboard flow observability, Go and container updates, and expanded middleware coverage.",
			Tech: []string{
				"Go",
				"HTMX",
				"Templ",
		...
		},
		{
			...
			Notes:           "Most recent work added safer public self-hosting guidance, streamlined contributor documentation, refreshed workflow notes, and expanded sanitized auth and learning flow observability.",
			Tech: []string{
				"Go",
				"Templ",
				"Tailwind CSS",
		...
		},
		{
			...
			LastUpdate:      "July 19, 2026",
			FirstCommitDate: "2026-01-04",
			Notes:           "Most recent work simplified the family Trophy Room with clearer shared trophies, a family top five, and streamlined totals, while refreshing self-hosting guidance and movie flow observability.",
			Tech: []string{
				"Go",
				"Templ",
				"Tailwind CSS",
		...
		},
		{
			...
			Notes:           "Most recent work refreshed portfolio project recency copy, added safer public self-hosting and environment setup guidance, and updated contributor workflow notes.",
			Tech: []string{
				"Go",
				"HTML templates",
				"Tailwind CSS",
		...
		},
		{
			...
			Notes:           "Most recent work added safer public self-hosting guidance, clarified container and production cookie setup, streamlined contributor documentation, and refreshed workflow notes.",
			Tech: []string{
				"Go",
				"Chi",
				"Angular",
