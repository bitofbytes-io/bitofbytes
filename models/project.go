...
func Projects() []Project {
	projects := []Project{
		...
		},
		{
			...
			Notes:           "Most recent work clarified database migration workflows and added an MIT license.",
			Tech: []string{
				"Go",
				"HTMX",
				"Tailwind-style CSS",
		...
		},
		{
			...
			Notes:           "Most recent work clarified contributor build prerequisites and refreshed workflow guidance alongside safer self-hosting documentation.",
			Tech: []string{
				"Go",
				"Templ",
				"Tailwind CSS",
		...
		},
		{
			...
			Notes:           "Most recent work clarified contributor build prerequisites while keeping movie runtimes inline in the simplified Trophy Room alongside its friendly awards and clearer totals.",
			Tech: []string{
				"Go",
				"Templ",
				"Tailwind CSS",
		...
		},
		{
			...
			Notes:           "Most recent work refreshed project recency copy and clarified local development workflow guidance.",
			Tech: []string{
				"Go",
				"HTML templates",
				"Tailwind CSS",
		...
		},
		{
			...
			Notes:           "Most recent work clarified frontend setup and local development workflows alongside safer self-hosting guidance.",
			Tech: []string{
				"Go",
				"Chi",
				"Angular",
