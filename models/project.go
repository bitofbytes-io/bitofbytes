...
func Projects() []Project {
	projects := []Project{
		...
		},
		{
			...
			Notes:           "Most recent work improved readiness estimates, save feedback, mobile checklist date inputs, and database setup documentation.",
			Tech: []string{
				"Go",
				"HTMX",
				"Templ",
		...
		},
		{
			...
			LastUpdate:      "May 13, 2026",
			FirstCommitDate: "2024-06-29",
			Notes:           "Most recent work applied the Field Notebook theme, added the Dined project page, refreshed favicons, and updated package and Docker build versions.",
			Tech: []string{
				"Go",
				"HTML templates",
				"Tailwind CSS",
		...
		},
		{
			...
			Notes:           "Most recent work updated package, Docker build, and web dependency versions.",
			Tech: []string{
				"Go",
				"Chi",
				"Angular",
