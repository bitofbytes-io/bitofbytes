	...
	projects := []Project{
		{
			...
			LastUpdate:      "May 17, 2026",
			FirstCommitDate: "2026-05-10",
			Notes:           "Most recent work added editable dines, restaurant overrides, saved-spot removal, Google Places metadata refreshes, safer delete flows, rating validation, and trophy-case polish.",
			Tech: []string{
				"Go",
				"HTMX",
				"Tailwind-style CSS",
		...
		},
		{
			...
			LastUpdate:      "May 11, 2026",
			FirstCommitDate: "2026-05-01",
			Notes:           "Most recent work improved readiness estimates, save feedback, mobile checklist date inputs, and database setup documentation for direct DATABASE_URL configuration.",
			Tech: []string{
				"Go",
				"HTMX",
				"Templ",
		...
		},
		{
			...
			LastUpdate:      "May 9, 2026",
			FirstCommitDate: "2026-01-02",
			Notes:           "Most recent work updated package and Docker build versions while refreshing repository workflow instructions.",
			Tech: []string{
				"Go",
				"Templ",
				"Tailwind CSS",
		...
		},
		{
			...
			Notes:           "Most recent work updated package and Docker build versions for the app.",
			Tech: []string{
				"Go",
				"Templ",
				"Tailwind CSS",
		...
		},
		{
			...
			Notes:           "Most recent work refreshed project update notes, updated BitOfBytes screenshots, applied the Field Notebook theme, added the Dined project page, refreshed favicons, and updated package and Docker build versions.",
			Tech: []string{
				"Go",
				"HTML templates",
				"Tailwind CSS",
		...
		},
		{
			...
			Notes:           "Most recent work updated package, Docker build, web dependency versions, and repository workflow instructions.",
			Tech: []string{
				"Go",
				"Chi",
				"Angular",
