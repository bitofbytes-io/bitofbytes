	...
	projects := []Project{
		{
			...
			LastUpdate:      "May 27, 2026",
			FirstCommitDate: "2026-05-10",
			Notes:           "Most recent work added richer trophy-case views, Google OAuth login, dine photo uploads, a proxied trophy map, production analytics, and safer restaurant workflows.",
			Tech: []string{
				"Go",
				"HTMX",
				"Tailwind-style CSS",
		...
		},
		{
			...
			Notes:           "Most recent work added production analytics, tightened session secret and origin validation, and updated the Go build version.",
			Tech: []string{
				"Go",
				"HTMX",
				"Templ",
		...
		},
		{
			...
			Notes:           "Most recent work hardened saved-source URL handling, configured the Gemini summary model, added production analytics, and updated Go and app dependencies.",
			Tech: []string{
				"Go",
				"Templ",
				"Tailwind CSS",
		...
		},
		{
			...
			Notes:           "Most recent work added signed browser sessions, same-origin protections, improved mobile search result cards, gated production analytics, and updated the Go build version.",
			Tech: []string{
				"Go",
				"Templ",
				"Tailwind CSS",
		...
		},
		{
			...
			Notes:           "Most recent work refreshed project notes and screenshots, updated the Dined trophy image, hardened browser headers, and moved production analytics into a CSP-safe script.",
			Tech: []string{
				"Go",
				"HTML templates",
				"Tailwind CSS",
		...
		},
		{
			...
			Notes:           "Most recent work added production analytics, same-origin request protections, a cleaner web dependency audit, and updated Go and web dependency versions.",
			Tech: []string{
				"Go",
				"Chi",
				"Angular",
